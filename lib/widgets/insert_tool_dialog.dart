              ...
              ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      boldText(context, context.localize('secocab'),
                          newTool.secocab.toString()),
                      boldText(context, context.localize('sandvikcab'),
                          newTool.sandvikcab.toString()),
                      boldText(context, context.localize('kennacab'),
                          newTool.kennacab.toString()),
                      boldText(context, context.localize('niagaracab'),
                          newTool.niagaracab.toString()),
